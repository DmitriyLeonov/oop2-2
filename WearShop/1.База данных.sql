...
FROM Openrowset( Bulk 'C:\ООП\oop2-2\WearShop\WearShop\Pictures\джемпер.jfif', Single_Blob) as img

insert into CLOTHES(SHORT_NAME,FULL_NAME,DESCRIPTION_CLOTH,CATEGORY,RATE,COST,COLOR,SIZE,IMAGE_ADRESS)
SELECT 'Nike Air Monarch','Кроссовки','Белые кроссовки','Обувь','9','36','Белый', '40', BulkColumn
FROM Openrowset( Bulk 'C:\ООП\oop2-2\WearShop\WearShop\Pictures\кроссовки.jfif', Single_Blob) as img
